...
const T: Record<string, Entry> = {
  ...
  "common.yes": { en: "Yes", sv: "Ja", de: "Ja" },
  "common.no": { en: "No", sv: "Nej", de: "Nein" },
  "trip.title": { en: "This trip", sv: "Den här resan", de: "Diese Reise" },
  "trip.distance": { en: "Distance", sv: "Sträcka", de: "Strecke" },
  "trip.days": { en: "Days", sv: "Dagar", de: "Tage" },
  "trip.nights": { en: "Nights", sv: "Nätter", de: "Nächte" },
  "trip.places": { en: "Places", sv: "Platser", de: "Orte" },
  "trip.solar": { en: "Solar", sv: "Solel", de: "Solar" },
  "trip.reset": { en: "New trip", sv: "Ny resa", de: "Neue Reise" },
  "trip.resetConfirm": {
    en: "Start a new trip from here?",
    sv: "Starta en ny resa härifrån?",
    de: "Neue Reise ab hier starten?",
  },
  ...
  "predictions.solarWindow": {
    en: "Best solar window",
    sv: "Bästa solfönster",
    de: "Bestes Solarfenster",
  },
  ...
  "scene.goodnight": { en: "Goodnight", sv: "Godnatt", de: "Gute Nacht" },
  "scene.morning": { en: "Good morning", sv: "God morgon", de: "Guten Morgen" },
  "scene.setup_camp": { en: "Set up camp", sv: "Slå läger", de: "Lager aufschlagen" },
  "scene.leaving": { en: "Leaving", sv: "Vi drar", de: "Aufbruch" },
  "journey.restrictions": { en: "Ahead", sv: "Framför", de: "Voraus" },
  "journey.maxHeight": { en: "max height", sv: "maxhöjd", de: "max. Höhe" },
  "journey.maxWeight": { en: "max weight", sv: "maxvikt", de: "max. Gewicht" },
  "journey.maxWidth": { en: "max width", sv: "maxbredd", de: "max. Breite" },
  ...
  "settings.routines": { en: "Routines", sv: "Rutiner", de: "Routinen" },
  "common.back": { en: "Back", sv: "Tillbaka", de: "Zurück" },
  "routines.note": {
    en: "Your automations. A routine starts from a button, a sensor threshold or a time of day, then runs its steps in order — every action still passes the safety layer.",
    sv: "Dina automationer. En rutin startar från en knapp, ett sensorvillkor eller en tid på dygnet och kör sedan sina steg i ordning — varje åtgärd går fortfarande genom säkerhetslagret.",
    de: "Deine Automationen. Eine Routine startet per Knopf, Sensorschwelle oder Uhrzeit und führt ihre Schritte der Reihe nach aus — jede Aktion durchläuft weiterhin die Sicherheitsebene.",
  },
  "routines.new": { en: "New routine", sv: "Ny rutin", de: "Neue Routine" },
  "routines.reset": {
    en: "Restore defaults",
    sv: "Återställ standard",
    de: "Standard wiederherstellen",
  },
  "routines.empty": {
    en: "No routines — create one or restore the defaults.",
    sv: "Inga rutiner — skapa en eller återställ standard.",
    de: "Keine Routinen — erstelle eine oder stelle die Standards wieder her.",
  },
  "routines.when": { en: "When", sv: "När", de: "Wenn" },
  "routines.do": { en: "Do", sv: "Gör", de: "Dann" },
  "routines.manual": {
    en: "Started manually",
    sv: "Startas manuellt",
    de: "Manuell gestartet",
  },
  "routines.at": { en: "At", sv: "Kl.", de: "Um" },
  "routines.addManual": { en: "Manual button", sv: "Manuell knapp", de: "Manueller Knopf" },
  "routines.addSensor": { en: "Sensor threshold", sv: "Sensorvillkor", de: "Sensorschwelle" },
  "routines.addTime": { en: "Time of day", sv: "Tid på dygnet", de: "Uhrzeit" },
  "routines.addAction": { en: "Control something", sv: "Styr något", de: "Etwas steuern" },
  "routines.addWait": { en: "Wait", sv: "Vänta", de: "Warten" },
  "routines.addCondition": {
    en: "Only continue if",
    sv: "Fortsätt bara om",
    de: "Nur fortfahren wenn",
  },
  "routines.addNotify": { en: "Notify", sv: "Meddela", de: "Benachrichtigen" },
  "routines.onlyIf": { en: "Only if", sv: "Bara om", de: "Nur wenn" },
  "routines.stopsHint": {
    en: "If an \"only continue if\" check fails, the routine stops there.",
    sv: "Om ett \"fortsätt bara om\"-villkor inte stämmer stoppar rutinen där.",
    de: "Schlägt eine \"Nur fortfahren wenn\"-Prüfung fehl, stoppt die Routine dort.",
  },
  "routines.isOn": { en: "is on", sv: "är på", de: "ist an" },
  "routines.isOff": { en: "is off", sv: "är av", de: "ist aus" },
  "routines.name": { en: "Name", sv: "Namn", de: "Name" },
  "routines.icon": { en: "Icon", sv: "Ikon", de: "Symbol" },
  "routines.enabled": { en: "Enabled", sv: "Aktiverad", de: "Aktiviert" },
  "routines.showOnHome": { en: "Show on home", sv: "Visa på hem", de: "Auf Start zeigen" },
